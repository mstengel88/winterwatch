...
export default function DriverDashboard() {
  ...
  if (isLoading) {
    return (
      <div className="flex min-h-screen items-center justify-center">
        <Loader2 className="h-8 w-8 animate-spin text-plow" />
      </div>
    );
  }
        ...
        <header className="border-b bg-card">
          <div className="container flex h-16 items-center justify-between px-4">
            <div className="flex items-center gap-3">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-plow">
                <Truck className="h-5 w-5 text-plow-foreground" />
              </div>
  ...
  return (
    <div className="min-h-screen bg-background theme-plow">
      {/* Header */}
      <header className="border-b bg-card">
        <div className="container flex h-16 items-center justify-between px-4">
          <div className="flex items-center gap-3">
      ...
      <main className="container space-y-6 px-4 py-6">
        ...
        <section>
          ...
          <RecentWorkList workLogs={recentWorkLogs} variant="plow" />
        </section>
      </main>
    </div>
  );
