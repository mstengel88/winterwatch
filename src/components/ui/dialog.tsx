...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn(
      // Keep overlay below the content so iOS Safari never hides the modal.
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    <DialogOverlay />
    {/*
      iOS Safari can show the overlay but render the translated fixed Content off-screen.
      Using a full-screen centering container avoids translate(-50%) issues.
    */}
